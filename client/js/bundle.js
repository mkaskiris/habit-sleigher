...
},{"./habit":3,"./main":5}],2:[function(require,module,exports){
...
if (document.querySelector("body > .hidden_form")) {
    ...
    async function habitlist() {
        ...
        try {
            ...
            habitCountData.forEach(async data1 => {
                ...
                const { hr, text, oldDateP, oldDateP2, oldDateP3, sec1 } = await oldData(data1)
                sec1.append(hr)
                sec1.append(text)
    ...
    async function oldData(data) {
        ...
        text.textContent = "Recent History:"
        ...
        return { hr, text, oldDateP, oldDateP2, oldDateP3, sec1 }
    }
...
},{"axios":6,"jwt-decode":35}],6:[function(require,module,exports){
...
},{"./adapters/http":7,"./adapters/xhr":7,"./core/enhanceError":17,"./helpers/normalizeHeaderName":30,"./utils":34,"_process":36}],22:[function(require,module,exports){
module.exports = {
  "version": "0.24.0"
};
