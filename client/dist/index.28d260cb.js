...
})({"aT5rn":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "2e4278c928d260cb";
"use strict";
...
},{}],"2sIA3":[function(require,module,exports) {
...
for (const tablink of tablinks)tablink.addEventListener('click', showForm);
// post request user login
async function loginUser(userData) {
    try {
        const res = await _axiosDefault.default.post(`${serverAPI}/auth/login`, userData);
        const token = res.data.token;
        const user = _jwtDecodeDefault.default(token);
        localStorage.setItem('token', token);
        localStorage.setItem('user_id', user._id);
        //localStorage.setItem("userEmail", user.email);
        output.textContent = `Welcome ${user.name}`;
        _axiosDefault.default.defaults.headers.common = {
            'Authorization': token
        };
    } catch (err) {
...
async function registerUser(userData) {
    try {
        const res = await _axiosDefault.default.post(`${serverAPI}/auth/register`, userData);
...
function showForm(e) {
    ...
    for (const tabBorder of tabBorders)tabBorder.className = tabBorder.className.replace(' w3-border-khaki', '');
    e.target.className += ' w3-border-khaki';
    const form1 = e.target.id.replace('-link', '');
...
},{"axios":"1IeuP","jwt-decode":"iykiX","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"1IeuP":[function(require,module,exports) {
...
},{}],"iykiX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "InvalidTokenError", ()=>n1
);
function e1(e) {
    this.message = e;
}
e1.prototype = new Error, e1.prototype.name = "InvalidCharacterError";
var r1 = "undefined" != typeof window && window.atob && window.atob.bind(window) || function(r) {
    var t = String(r).replace(/=+$/, "");
    if (t.length % 4 == 1) throw new e1("'atob' failed: The string to be decoded is not correctly encoded.");
...
function t1(e2) {
    ...
    try {
        return (function(e) {
            return decodeURIComponent(r1(e).replace(/(.)/g, function(e, r) {
...
function o1(e, r) {
    if ("string" != typeof e) throw new n1("Invalid token specified");
    var o = !0 === (r = r || {
    }).header ? 0 : 1;
    try {
        return JSON.parse(t1(e.split(".")[o]));
    } catch (e3) {
        throw new n1("Invalid token specified: " + e3.message);
    }
}
n1.prototype = new Error, n1.prototype.name = "InvalidTokenError";
exports.default = o1;
...
},{}]},["aT5rn","2sIA3"], "2sIA3", "parcelRequiree8ef")

//# sourceMappingURL=index.28d260cb.js.map
